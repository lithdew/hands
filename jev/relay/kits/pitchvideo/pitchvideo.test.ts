...
const fakeWs = (json: string): Workspace => { const ws: Workspace = { dir: "/nowhere", notes: {}, sources: {}, files: { "video/script.json": json }, log: () => {}, async write(path, content) { ws.files[path] = content; } }; return ws; };
