...
const allowedStrings: Record<string, readonly string[]> = {
  ...
  action: ["windows", "window", "screen", "attach", "tabs", "snapshot", "query", "canvas_snapshot", "canvas_click", "canvas_drag", "focused_text", "navigate", "click", "type", "key", "scroll", "dialog", "set_value", "screenshot", "batch", "draw", "move"],
