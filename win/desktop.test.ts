...
import { bindWindowCapture, capturedImage, createDriverPool, createExistingBrowserTargets, createWindowTracker, frontWindow, isPrivateBrowser, launchedBrowserWindow, type RawWindow, type WindowOwner } from "./desktop";
