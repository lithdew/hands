...
import { bindWindowCapture, capturedImage, createDriverPool, createWindowTracker, frontWindow, isPrivateBrowser, launchedBrowserWindow, type RawWindow, type WindowOwner } from "./desktop";
